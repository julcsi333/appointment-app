          ...
          <Paper>
            <Card sx={{ display: 'flex' }}>
              <CardMedia
                component="img"
                sx={{ width: 150 }}
                image={provider.imageUrl === undefined ? "https://idea7.co.uk/wp-content/uploads/2021/02/placeholder-250x250-1.png" : provider.imageUrl}
                alt={provider.name}
